...
if(isset($_POST['btnsearch']))
{
 ...
 $id_num = htmlentities(mysqli_real_escape_string($con,$_POST['id_num']));


 $query = "SELECT * FROM generateacc where id_num = '$id_num'" ;
...
<html>
  ...
  <title>Generate Account-Banc ABC</title>
  <!-- Font Awesome -->
...
<a href="generateAcc.php"><button type="button" name="button" class="btn btn-success">Dasboard</button></a>
</div>

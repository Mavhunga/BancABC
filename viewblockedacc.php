...
<html>
  ...
  <title>Blocked Accounts-Banc ABC</title>
  <!-- Font Awesome -->
...
<div class="row">
  ...
  <div class="col-md-4 sen">
    <form class="" action="searchblockedAcc.php" method="post">
      <input type="text" class="form-control input-lg" name="txtid" placeholder="National Id Number" required autocomplete="off" ></input>
...
<div class="row">
  ...
  <div class="col-md-10 table-responsive">
    <table class="table table-striped table-hover table-condensed " algin="centre">
      <thead>
        <h1 align="center" colour:white >View Blocked Clients Details</h1>
      </thead>
      <tr>
